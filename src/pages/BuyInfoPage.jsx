...
export default function BuyInfoPage({ onExploreClick }) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 pb-20">
      ...
      {/* HERO SECTION */}
      <div className="bg-slate-900 border-b border-slate-800 text-white py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xl">
            ...
            <h3 className="text-base font-extrabold text-slate-900 mb-2">Deep Geographic Search</h3>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xl">
            ...
            <h3 className="text-base font-extrabold text-slate-900 mb-2">Interactive Map & Boundaries</h3>
            <p className="text-xs text-slate-700 font-semibold leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xl">
            ...
            <h3 className="text-base font-extrabold text-slate-900 mb-2">Platform Verification</h3>
            <p className="text-xs text-slate-700 font-semibold leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xl">
            ...
            <h3 className="text-base font-extrabold text-slate-900 mb-2">Direct Owner Connection</h3>
            <p className="text-xs text-slate-700 font-semibold leading-relaxed">
