            ...
            {CANONICAL_AMENITIES_LIST.map(amenity => {
              ...
              return (
                <button
                  ...
                  className={`p-2 rounded-lg text-[11px] font-semibold border flex items-center gap-1.5 transition-colors ${
                    selected
                ...
                >
                  <div className={`w-3.5 h-3.5 rounded flex items-center justify-center border ${
                    selected ? 'bg-amber-600 border-amber-600 text-white' : 'border-gray-300 bg-white'
                  }`}>
